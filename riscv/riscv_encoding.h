...
#ifndef MPACT_RISCV_RISCV_RISCV_ENCODING_H_
#define MPACT_RISCV_RISCV_RISCV_ENCODING_H_
...
class RiscV32GEncoding : public Riscv32gEncodingBase {
 public:
  ...
  // particular operand field.
  DestinationOperandInterface *GetDestination(int latency, SlotEnum, int,
                                              OpcodeEnum, DestOpEnum op,
                                              int dest_no) override;
...
#endif  // MPACT_RISCV_RISCV_RISCV_ENCODING_H_
