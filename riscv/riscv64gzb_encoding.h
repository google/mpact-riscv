...
#ifndef THIRD_PARTY_MPACT_RISCV_RISCV64GZB_ENCODING_H_
#define THIRD_PARTY_MPACT_RISCV_RISCV64GZB_ENCODING_H_
...
class RiscV64GZBEncoding : public RiscV64GZBEncodingBase,
                           public RiscVEncodingCommon {
 public:
  explicit RiscV64GZBEncoding(RiscVState *state);
  ~RiscV64GZBEncoding() override;
...
#endif  // THIRD_PARTY_MPACT_RISCV_RISCV64GZB_ENCODING_H_
