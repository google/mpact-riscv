...
#ifndef RISCV_RISCV_VECTOR_FP_REDUCTION_INSTRUCTIONS_H_
#define RISCV_RISCV_VECTOR_FP_REDUCTION_INSTRUCTIONS_H_
...
#endif  // RISCV_RISCV_VECTOR_FP_REDUCTION_INSTRUCTIONS_H_
